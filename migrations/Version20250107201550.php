 ...
 */
final class Version20250107201550 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD delivery_address VARCHAR(255) DEFAULT NULL, DROP street, DROP city, DROP zip, DROP country, DROP state');
    }
}
